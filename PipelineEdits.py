...
if arguments.start == 0:
	...
	vsgf.trimSequences(header, arguments.g, trinityfiles)
	if arguments.stop >1:
		vsgf.trinity(header, arguments.minp, trinityfiles, arguments.mem)
		if arguments.stop > 2:
			vsgf.findORFs(header, arguments.minp, trinityfiles)
			if arguments.stop > 3:
				vsgf.blastCDHIT(header, trinityfiles, arguments.vsgdb, arguments.sit)
				if arguments.stop > 4:
					vsgf.makeMulto(header, trinityfiles, arguments.p, arguments.v, arguments.cpu)
# start with trimmmed files
	...
	trinityfiles =  vsgf.makeFilesListTrimmed(arguments.s, arguments.st)
	if arguments.stop >1:
		vsgf.trinity(header, arguments.minp, trinityfiles, arguments.mem)
		if arguments.stop > 2:
			vsgf.findORFs(header, arguments.minp, trinityfiles)
...
# start with trinity files
	...
	trinityfiles =  vsgf.makeFilesListTrinity(arguments.s, arguments.st)
	if arguments.stop > 2:
		vsgf.findORFs(header, arguments.minp, trinityfiles)
		if arguments.stop > 3:
			vsgf.blastCDHIT(header, trinityfiles, arguments.vsgdb, arguments.sit)
...
# start with ORFs
	...
	trinityfiles =  vsgf.makeFilesListORF(arguments.s, arguments.st)
	if arguments.stop > 3:
		vsgf.blastCDHIT(header, trinityfiles, arguments.vsgdb, arguments.sit)
		if arguments.stop > 4:
			vsgf.makeMulto(header, trinityfiles, arguments.p, arguments.v, arguments.cpu)
# start with BLAST-ed VSG ORFs
	...
	trinityfiles =  vsgf.makeFilesListORF(arguments.s, arguments.st)
	if arguments.stop > 4:
		vsgf.makeMulto(header, trinityfiles, arguments.p, arguments.v, arguments.cpu, arguments.rmulto)
else:
