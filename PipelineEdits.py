...
parser.add_argument('-NoNonVSGdb', dest='NoNonVSGdb', action='store_true')
...
parser.add_argument('-v', help='number of mismatches allowed, bowtie step', action="store", dest='v', default='2')
parser.add_argument('-reuseMulto', help='name of the multo files to be resued, typically same as header, default will make new MULTo files', action="store", dest='rmulto', default='')
